				...
				<div class="row">
					...
					<div class="col-8 mt-5">
						<div class="card">
							...
							<div class="card-body">
								<form action="inc/doctor/store.php" method="POST" enctype="multipart/form-data">
									<div class="form-group">
										<label for="doctor_name">Doctor Name:</label>
										<input type="text" id="doctor_name" class="form-control" name="doctor_name" placeholder="Doctor Name e.g. Dr. Someone...">
									</div>
									<div class="form-group">
										<label for="doctor_designation">Doctor Degisnation:</label>
										<input type="text" id="doctor_designation" class="form-control" name="doctor_designation" placeholder="Doctor Degisnation e.g. Assistant Prof...">
									</div>
									<div class="form-group">
										<label for="doctor_contact">Contact Number:</label>
										<input type="text" id="doctor_contact" class="form-control" name="doctor_contact" placeholder="Contact Number...">
									</div>
									<div class="form-group">
